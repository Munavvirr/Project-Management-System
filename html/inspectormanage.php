            ...
            <div class="container-fluid">
                ...
                <!-- Start First Cards -->
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium">Create New Inspector</h2>
                                      <br>
                    ...
                    <div class="card border-right">
                        ...
                        <form style="padding:50px" method="post" action="regins.php">
                              <div class="mb-3">
  ...
  <button type="submit" class="btn btn-primary">Submit</button>
                ...
                <!-- *************************************************************** -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Inspectors
                            </h4>
                                ...
                                <div class="table-responsive">
                                    ...
                                    $result = mysqli_query($conn,"SELECT * FROM inspector");
                        ?>
                                <?php
