            ...
            <div class="container-fluid">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium">Assign Employee to Assignment </h2>
                                      <br>
                ...
                <!-- *************************************************************** -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Task Page</h4>
                                ...
                                <div class="table-responsive">
                                   ...
                                   <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                    ...
                                    $result = mysqli_query($conn,"SELECT * FROM task WHERE task_cost !=''");
                        ?>
                                <?php
...
?>
                                ...
                                <div class="ps-2"><?php echo $row["task_status"]; ?></div>
                                             ...
                                             <td>
                                                  <?php
                                             if($row['employee_assigned']=="Yet to be Assigned"){ ?>
                                            
                                            		 <form method="post" action="updatetaskemp.php">
						     <br>
    ...
    $query ="SELECT user_name FROM emp";
    $result = $conn->query($query);
    if($result->num_rows> 0){
        while($optionData=$result->fetch_assoc()){
        $option =$optionData['user_name'];
    ?>
