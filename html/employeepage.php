                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html">Employee Dashboard</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium">Check your New Assignments</h2>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    $result = mysqli_query($conn,"SELECT * FROM task WHERE employee_assigned='$username'");
                        ?>
                                <?php
                                    if (mysqli_num_rows($result) > 0) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <th>Status</th>
                                                <th>File</th>
                                                <th>Submit Completed Assignment</th>
...
?>
                                ...
                                <div class="ps-2"><?php echo $row["task_status"]; ?></div>
                                             ...
                                             <td> <?php if (strlen($row['fileaddress'])>2) { echo '<p><a href="download.php?file=' . urlencode($row['fileaddress']) . '">Download</a></p>';} else { echo "No File Uploaded";} ?></td>
                                             <td>
                                                 <?php if($row['submittedfileaddress']==""){
                                                 ?>
                                                 <form method="POST" action="finalfile.php" enctype="multipart/form-data">
                                                     <input type="text" value="<?php echo $row['task_id'] ?>" hidden name="taskid">
                                            <input type='file' name='uploadedFile' />
                <button type='submit' name='uploadfile2'>UPLOAD</button>
                </form>
                <?php } ?>
                                             </td>
...
echo "No Task Assigned to you Yet, Check Back later";
}
?>
                                </div>
                            </div>
