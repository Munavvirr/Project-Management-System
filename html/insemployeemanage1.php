<?php
 ...
 (new Auth())->requireLoginInspector();
...
<head>
    ...
    <title>Projects.ae - Employee Management</title>
    <!-- Custom CSS -->
...
<body>
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="inspectorpage.php"
                                aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span
                                    class="hide-menu">Inspector Dashboard</span></a></li>
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">Applications</span>
                        </li>

                        <li class="sidebar-item"> <a class="sidebar-link" href="insemployeemanage1.php"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">Employee Management
                                </span></a>
                        </li>
                         <li class="sidebar-item"> <a class="sidebar-link" href="insassigntask1.php"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html"> Inspector Dashboard</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <!-- Start First Cards -->
                    ...
                    <div class="card border-right">
                        <a href="uploadassign.php"><div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium">Create New Employee</h2>
                                      <br>
                    ...
                    <div class="card border-right">
                        ...
                        <form style="padding:50px" method="post" action="insregemp.php">
                              <div class="mb-3">
    ...
    <input type="phone" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="number">
  </div>
  <div class="mb-3">
...
?>
                                            ...
                                            <td><?php echo $row["user_name"]; ?></td>
                                             ...
                                             <td><?php echo $row["user_timestamp"]; ?></td>
                                             <td>  <div class="d-inline-flex align-items-center active">
                               
                                <div class="ps-2"><?php echo $row["user_status"]; ?></div>
                            </div>
                            </td>
                                        <td> <?php echo $row['user_phone'] ?></td>
                                        <td> <a href="deleteemp.php?userid=<?php echo $row["user_id"]; ?>">Delete</a></td>
                                            </tr>
...
echo "No Employees Created Yet, Click Above to Create new Employee";
}
?>
                                </div>
                            </div>
