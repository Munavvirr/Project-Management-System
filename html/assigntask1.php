...
?>
                                ...
                                <div class="ps-2"><?php echo $row["task_status"]; ?></div>
                                             ...
                                             echo "Kindly wait for Cost";}?></td>
                                             <td> <?php echo '<p><a href="download.php?file=' . urlencode($row['fileaddress']) . '">Download</a></p>'; ?></td>
                                             <td>
                                                  <?php
                                             if($row['employee_assigned']=="Yet to be Assigned" && $row['task_status']!="Cost Declined"){ ?>
   ...
   <?php
    ...
    ?>
						     ...
						     <button class="btn btn-light">Submit</button>
                                             ...
                                             <?php }else if ($row['employee_assigned']!="Yet to be Assigned" && $row['employee_assigned']!=""){
                                                 ?>
                                                  <form method="post" action="reassign.php">
					
						     <input value='<?php echo $row['task_id']?>' name="taskid" hidden >
						    
						     <button class="btn btn-light">Re Assign Employee</button>
